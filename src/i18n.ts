...
const EN = {
	...
	tbCheckbox: "Checkbox",
	tbCheckboxRemove: "Remove checkbox",
	...
	/* 1.7.0: undo/redo, version history, the save indicator */
	tbUndo: "Undo",
	tbRedo: "Redo",
	histNothingUndo: "Nothing left to undo.",
	histNothingRedo: "Nothing left to redo.",
	saveDirty: "Unsaved changes…",
	saveSaving: "Saving…",
	saveJustNow: "Saved just now",
	saveAt: "Saved at {time}",
	saveFailedShort: "Save failed",
	saveFailedNotice: "Spreadsheet Notes: could not save this spreadsheet ({message})",
	vhTitle: "Version history",
	vhEmpty: "No versions yet. One is kept every time the file is saved.",
	vhCount: "{count} versions",
	vhPreviewHint: "Pick a version to see it here.",
	vhRestore: "Restore",
	vhDelete: "Delete",
	vhDeleteTitle: "Delete this version?",
	vhDeleteBody: "The version from {time} will be removed from the backup folder. The spreadsheet itself is not touched.",
	vhDeleted: "Version deleted",
	vhRestored: "Restored the version from {time}",
	vhReadFailed: "Could not read this version ({message})",
	vhNoView: "Spreadsheet Notes: could not open this spreadsheet to show its history.",
	vhCreated: "First kept version",
	vhLayout: "Layout changed",
	vhNoChange: "No cell changes",
	vhChanged: "{list} changed",
	vhChangedMore: "{list} and {count} more changed",
	vhSizeKb: "{count} KB",
} as const;
...
const RU: Record<StringKey, string> = {
	...
	tbCheckbox: "Флажок",
	tbCheckboxRemove: "Убрать флажок",
	...
	tbUndo: "Отменить",
	tbRedo: "Вернуть",
	histNothingUndo: "Отменять больше нечего.",
	histNothingRedo: "Возвращать больше нечего.",
	saveDirty: "Изменения…",
	saveSaving: "Сохранение…",
	saveJustNow: "Сохранено только что",
	saveAt: "Сохранено в {time}",
	saveFailedShort: "Ошибка сохранения",
	saveFailedNotice: "Spreadsheet Notes: не удалось сохранить таблицу ({message})",
	vhTitle: "История версий",
	vhEmpty: "Версий пока нет. Версия сохраняется при каждой записи файла.",
	vhCount: "Версий: {count}",
	vhPreviewHint: "Выберите версию, чтобы увидеть её здесь.",
	vhRestore: "Восстановить",
	vhDelete: "Удалить",
	vhDeleteTitle: "Удалить эту версию?",
	vhDeleteBody: "Версия от {time} будет удалена из папки резервных копий. Сама таблица не изменится.",
	vhDeleted: "Версия удалена",
	vhRestored: "Восстановлена версия от {time}",
	vhReadFailed: "Не удалось прочитать эту версию ({message})",
	vhNoView: "Spreadsheet Notes: не удалось открыть таблицу, чтобы показать её историю.",
	vhCreated: "Первая сохранённая версия",
	vhLayout: "Изменена структура",
	vhNoChange: "Без изменений в ячейках",
	vhChanged: "Изменено: {list}",
	vhChangedMore: "Изменено: {list} и ещё {count}",
	vhSizeKb: "{count} КБ",
};
...
const ZH: Record<StringKey, string> = {
	...
	tbUndo: "撤销",
	tbRedo: "重做",
	histNothingUndo: "没有可撤销的操作。",
	histNothingRedo: "没有可重做的操作。",
	saveDirty: "有未保存的更改…",
	saveSaving: "正在保存…",
	saveJustNow: "刚刚已保存",
	saveAt: "已于 {time} 保存",
	saveFailedShort: "保存失败",
	saveFailedNotice: "Spreadsheet Notes：无法保存此表格（{message}）",
	vhTitle: "版本历史",
	vhEmpty: "暂无版本。每次保存文件时都会保留一个版本。",
	vhCount: "共 {count} 个版本",
	vhPreviewHint: "选择一个版本以在此预览。",
	vhRestore: "恢复",
	vhDelete: "删除",
	vhDeleteTitle: "删除此版本？",
	vhDeleteBody: "{time} 的版本将从备份文件夹中删除，表格本身不受影响。",
	vhDeleted: "版本已删除",
	vhRestored: "已恢复 {time} 的版本",
	vhReadFailed: "无法读取此版本（{message}）",
	vhNoView: "Spreadsheet Notes：无法打开该表格以显示历史记录。",
	vhCreated: "首个保留版本",
	vhLayout: "布局已更改",
	vhNoChange: "单元格没有变化",
	vhChanged: "{list} 已更改",
	vhChangedMore: "{list} 及另外 {count} 处已更改",
	vhSizeKb: "{count} KB",
};
...
const ZH_TW: Record<StringKey, string> = {
	...
	tbUndo: "復原",
	tbRedo: "重做",
	histNothingUndo: "沒有可復原的操作。",
	histNothingRedo: "沒有可重做的操作。",
	saveDirty: "有未儲存的變更…",
	saveSaving: "正在儲存…",
	saveJustNow: "剛剛已儲存",
	saveAt: "已於 {time} 儲存",
	saveFailedShort: "儲存失敗",
	saveFailedNotice: "Spreadsheet Notes：無法儲存此表格（{message}）",
	vhTitle: "版本紀錄",
	vhEmpty: "尚無版本。每次儲存檔案時都會保留一個版本。",
	vhCount: "共 {count} 個版本",
	vhPreviewHint: "選擇一個版本以在此預覽。",
	vhRestore: "還原",
	vhDelete: "刪除",
	vhDeleteTitle: "刪除此版本？",
	vhDeleteBody: "{time} 的版本將從備份資料夾中刪除，表格本身不受影響。",
	vhDeleted: "版本已刪除",
	vhRestored: "已還原 {time} 的版本",
	vhReadFailed: "無法讀取此版本（{message}）",
	vhNoView: "Spreadsheet Notes：無法開啟該表格以顯示紀錄。",
	vhCreated: "首個保留版本",
	vhLayout: "版面已變更",
	vhNoChange: "儲存格沒有變更",
	vhChanged: "{list} 已變更",
	vhChangedMore: "{list} 及另外 {count} 處已變更",
	vhSizeKb: "{count} KB",
};
...
const DE: Record<StringKey, string> = {
	...
	tbCheckboxRemove: "Kontrollkästchen entfernen",
	...
	tbUndo: "Rückgängig",
	tbRedo: "Wiederholen",
	histNothingUndo: "Nichts mehr rückgängig zu machen.",
	histNothingRedo: "Nichts mehr zu wiederholen.",
	saveDirty: "Nicht gespeichert…",
	saveSaving: "Wird gespeichert…",
	saveJustNow: "Gerade gespeichert",
	saveAt: "Gespeichert um {time}",
	saveFailedShort: "Speichern fehlgeschlagen",
	saveFailedNotice: "Spreadsheet Notes: Diese Tabelle konnte nicht gespeichert werden ({message})",
	vhTitle: "Versionsverlauf",
	vhEmpty: "Noch keine Versionen. Bei jedem Speichern wird eine behalten.",
	vhCount: "{count} Versionen",
	vhPreviewHint: "Wähle eine Version, um sie hier zu sehen.",
	vhRestore: "Wiederherstellen",
	vhDelete: "Löschen",
	vhDeleteTitle: "Diese Version löschen?",
	vhDeleteBody: "Die Version von {time} wird aus dem Sicherungsordner entfernt. Die Tabelle selbst bleibt unberührt.",
	vhDeleted: "Version gelöscht",
	vhRestored: "Version von {time} wiederhergestellt",
	vhReadFailed: "Diese Version konnte nicht gelesen werden ({message})",
	vhNoView: "Spreadsheet Notes: Die Tabelle konnte nicht geöffnet werden, um den Verlauf zu zeigen.",
	vhCreated: "Erste behaltene Version",
	vhLayout: "Layout geändert",
	vhNoChange: "Keine Zelländerungen",
	vhChanged: "{list} geändert",
	vhChangedMore: "{list} und {count} weitere geändert",
	vhSizeKb: "{count} KB",
};
...
const FR: Record<StringKey, string> = {
	...
	tbCheckboxRemove: "Supprimer la case à cocher",
	...
	tbUndo: "Annuler",
	tbRedo: "Rétablir",
	histNothingUndo: "Plus rien à annuler.",
	histNothingRedo: "Plus rien à rétablir.",
	saveDirty: "Modifications non enregistrées…",
	saveSaving: "Enregistrement…",
	saveJustNow: "Enregistré à l'instant",
	saveAt: "Enregistré à {time}",
	saveFailedShort: "Échec de l'enregistrement",
	saveFailedNotice: "Spreadsheet Notes : impossible d'enregistrer cette feuille ({message})",
	vhTitle: "Historique des versions",
	vhEmpty: "Aucune version pour l'instant. Une version est conservée à chaque enregistrement.",
	vhCount: "{count} versions",
	vhPreviewHint: "Choisissez une version pour l'afficher ici.",
	vhRestore: "Restaurer",
	vhDelete: "Supprimer",
	vhDeleteTitle: "Supprimer cette version ?",
	vhDeleteBody: "La version du {time} sera supprimée du dossier de sauvegarde. La feuille elle-même n'est pas touchée.",
	vhDeleted: "Version supprimée",
	vhRestored: "Version du {time} restaurée",
	vhReadFailed: "Impossible de lire cette version ({message})",
	vhNoView: "Spreadsheet Notes : impossible d'ouvrir cette feuille pour afficher son historique.",
	vhCreated: "Première version conservée",
	vhLayout: "Mise en page modifiée",
	vhNoChange: "Aucune cellule modifiée",
	vhChanged: "{list} modifiée(s)",
	vhChangedMore: "{list} et {count} autres modifiées",
	vhSizeKb: "{count} Ko",
};
...
const ES: Record<StringKey, string> = {
	...
	tbCheckbox: "Casilla",
	tbCheckboxRemove: "Quitar casilla",
	...
	tbUndo: "Deshacer",
	tbRedo: "Rehacer",
	histNothingUndo: "No queda nada por deshacer.",
	histNothingRedo: "No queda nada por rehacer.",
	saveDirty: "Cambios sin guardar…",
	saveSaving: "Guardando…",
	saveJustNow: "Guardado ahora mismo",
	saveAt: "Guardado a las {time}",
	saveFailedShort: "Error al guardar",
	saveFailedNotice: "Spreadsheet Notes: no se pudo guardar esta hoja ({message})",
	vhTitle: "Historial de versiones",
	vhEmpty: "Todavía no hay versiones. Se guarda una cada vez que se escribe el archivo.",
	vhCount: "{count} versiones",
	vhPreviewHint: "Elige una versión para verla aquí.",
	vhRestore: "Restaurar",
	vhDelete: "Eliminar",
	vhDeleteTitle: "¿Eliminar esta versión?",
	vhDeleteBody: "La versión de {time} se eliminará de la carpeta de copias. La hoja no se modifica.",
	vhDeleted: "Versión eliminada",
	vhRestored: "Versión de {time} restaurada",
	vhReadFailed: "No se pudo leer esta versión ({message})",
	vhNoView: "Spreadsheet Notes: no se pudo abrir la hoja para mostrar su historial.",
	vhCreated: "Primera versión guardada",
	vhLayout: "Diseño modificado",
	vhNoChange: "Sin cambios en las celdas",
	vhChanged: "{list} modificadas",
	vhChangedMore: "{list} y {count} más modificadas",
	vhSizeKb: "{count} KB",
};
...
const JA: Record<StringKey, string> = {
	...
	tbUndo: "元に戻す",
	tbRedo: "やり直し",
	histNothingUndo: "元に戻せる操作はありません。",
	histNothingRedo: "やり直せる操作はありません。",
	saveDirty: "未保存の変更…",
	saveSaving: "保存中…",
	saveJustNow: "たった今保存しました",
	saveAt: "{time} に保存しました",
	saveFailedShort: "保存に失敗しました",
	saveFailedNotice: "Spreadsheet Notes: このシートを保存できませんでした（{message}）",
	vhTitle: "バージョン履歴",
	vhEmpty: "まだバージョンはありません。ファイルを保存するたびに 1 つ残します。",
	vhCount: "バージョン {count} 件",
	vhPreviewHint: "バージョンを選ぶとここに表示されます。",
	vhRestore: "復元",
	vhDelete: "削除",
	vhDeleteTitle: "このバージョンを削除しますか？",
	vhDeleteBody: "{time} のバージョンをバックアップフォルダーから削除します。シート自体は変わりません。",
	vhDeleted: "バージョンを削除しました",
	vhRestored: "{time} のバージョンを復元しました",
	vhReadFailed: "このバージョンを読み込めませんでした（{message}）",
	vhNoView: "Spreadsheet Notes: 履歴を表示するためにシートを開けませんでした。",
	vhCreated: "最初に保存されたバージョン",
	vhLayout: "レイアウトを変更",
	vhNoChange: "セルの変更なし",
	vhChanged: "{list} を変更",
	vhChangedMore: "{list} ほか {count} 件を変更",
	vhSizeKb: "{count} KB",
};
...
const KO: Record<StringKey, string> = {
	...
	tbUndo: "실행 취소",
	tbRedo: "다시 실행",
	histNothingUndo: "취소할 작업이 없습니다.",
	histNothingRedo: "다시 실행할 작업이 없습니다.",
	saveDirty: "저장되지 않은 변경…",
	saveSaving: "저장 중…",
	saveJustNow: "방금 저장됨",
	saveAt: "{time}에 저장됨",
	saveFailedShort: "저장 실패",
	saveFailedNotice: "Spreadsheet Notes: 이 시트를 저장할 수 없습니다({message})",
	vhTitle: "버전 기록",
	vhEmpty: "아직 버전이 없습니다. 파일을 저장할 때마다 하나씩 보관합니다.",
	vhCount: "버전 {count}개",
	vhPreviewHint: "버전을 선택하면 여기에 표시됩니다.",
	vhRestore: "복원",
	vhDelete: "삭제",
	vhDeleteTitle: "이 버전을 삭제할까요?",
	vhDeleteBody: "{time}의 버전을 백업 폴더에서 지웁니다. 시트 자체는 바뀌지 않습니다.",
	vhDeleted: "버전을 삭제했습니다",
	vhRestored: "{time}의 버전을 복원했습니다",
	vhReadFailed: "이 버전을 읽을 수 없습니다({message})",
	vhNoView: "Spreadsheet Notes: 기록을 표시하기 위해 시트를 열 수 없습니다.",
	vhCreated: "처음 보관된 버전",
	vhLayout: "레이아웃 변경됨",
	vhNoChange: "셀 변경 없음",
	vhChanged: "{list} 변경됨",
	vhChangedMore: "{list} 외 {count}개 변경됨",
	vhSizeKb: "{count} KB",
};
...
const PT_BR: Record<StringKey, string> = {
	...
	tbCheckboxRemove: "Remover caixa de seleção",
	...
	tbUndo: "Desfazer",
	tbRedo: "Refazer",
	histNothingUndo: "Não há mais nada para desfazer.",
	histNothingRedo: "Não há mais nada para refazer.",
	saveDirty: "Alterações não salvas…",
	saveSaving: "Salvando…",
	saveJustNow: "Salvo agora mesmo",
	saveAt: "Salvo às {time}",
	saveFailedShort: "Falha ao salvar",
	saveFailedNotice: "Spreadsheet Notes: não foi possível salvar esta planilha ({message})",
	vhTitle: "Histórico de versões",
	vhEmpty: "Ainda não há versões. Uma é guardada a cada gravação do arquivo.",
	vhCount: "{count} versões",
	vhPreviewHint: "Escolha uma versão para vê-la aqui.",
	vhRestore: "Restaurar",
	vhDelete: "Excluir",
	vhDeleteTitle: "Excluir esta versão?",
	vhDeleteBody: "A versão de {time} será removida da pasta de backups. A planilha em si não é alterada.",
	vhDeleted: "Versão excluída",
	vhRestored: "Versão de {time} restaurada",
	vhReadFailed: "Não foi possível ler esta versão ({message})",
	vhNoView: "Spreadsheet Notes: não foi possível abrir a planilha para mostrar o histórico.",
	vhCreated: "Primeira versão guardada",
	vhLayout: "Layout alterado",
	vhNoChange: "Nenhuma célula alterada",
	vhChanged: "{list} alteradas",
	vhChangedMore: "{list} e mais {count} alteradas",
	vhSizeKb: "{count} KB",
};
...
const IT: Record<StringKey, string> = {
	...
	tbCheckboxRemove: "Rimuovi casella di controllo",
	...
	tbUndo: "Annulla",
	tbRedo: "Ripeti",
	histNothingUndo: "Non c'è più nulla da annullare.",
	histNothingRedo: "Non c'è più nulla da ripetere.",
	saveDirty: "Modifiche non salvate…",
	saveSaving: "Salvataggio…",
	saveJustNow: "Salvato proprio ora",
	saveAt: "Salvato alle {time}",
	saveFailedShort: "Salvataggio non riuscito",
	saveFailedNotice: "Spreadsheet Notes: impossibile salvare questo foglio ({message})",
	vhTitle: "Cronologia versioni",
	vhEmpty: "Ancora nessuna versione. Ne viene conservata una a ogni salvataggio.",
	vhCount: "{count} versioni",
	vhPreviewHint: "Scegli una versione per vederla qui.",
	vhRestore: "Ripristina",
	vhDelete: "Elimina",
	vhDeleteTitle: "Eliminare questa versione?",
	vhDeleteBody: "La versione delle {time} sarà rimossa dalla cartella dei backup. Il foglio non viene toccato.",
	vhDeleted: "Versione eliminata",
	vhRestored: "Ripristinata la versione delle {time}",
	vhReadFailed: "Impossibile leggere questa versione ({message})",
	vhNoView: "Spreadsheet Notes: impossibile aprire il foglio per mostrarne la cronologia.",
	vhCreated: "Prima versione conservata",
	vhLayout: "Layout modificato",
	vhNoChange: "Nessuna cella modificata",
	vhChanged: "{list} modificate",
	vhChangedMore: "{list} e altre {count} modificate",
	vhSizeKb: "{count} KB",
};
...
const PL: Record<StringKey, string> = {
	...
	tbCheckboxRemove: "Usuń pole wyboru",
	...
	tbUndo: "Cofnij",
	tbRedo: "Ponów",
	histNothingUndo: "Nie ma już czego cofać.",
	histNothingRedo: "Nie ma już czego ponawiać.",
	saveDirty: "Niezapisane zmiany…",
	saveSaving: "Zapisywanie…",
	saveJustNow: "Zapisano przed chwilą",
	saveAt: "Zapisano o {time}",
	saveFailedShort: "Błąd zapisu",
	saveFailedNotice: "Spreadsheet Notes: nie udało się zapisać tego arkusza ({message})",
	vhTitle: "Historia wersji",
	vhEmpty: "Nie ma jeszcze wersji. Powstaje przy każdym zapisie pliku.",
	vhCount: "Wersje: {count}",
	vhPreviewHint: "Wybierz wersję, aby zobaczyć ją tutaj.",
	vhRestore: "Przywróć",
	vhDelete: "Usuń",
	vhDeleteTitle: "Usunąć tę wersję?",
	vhDeleteBody: "Wersja z {time} zostanie usunięta z folderu kopii. Sam arkusz pozostaje bez zmian.",
	vhDeleted: "Wersja usunięta",
	vhRestored: "Przywrócono wersję z {time}",
	vhReadFailed: "Nie udało się odczytać tej wersji ({message})",
	vhNoView: "Spreadsheet Notes: nie udało się otworzyć arkusza, aby pokazać historię.",
	vhCreated: "Pierwsza zachowana wersja",
	vhLayout: "Zmieniono układ",
	vhNoChange: "Bez zmian w komórkach",
	vhChanged: "Zmieniono {list}",
	vhChangedMore: "Zmieniono {list} i {count} więcej",
	vhSizeKb: "{count} KB",
};
